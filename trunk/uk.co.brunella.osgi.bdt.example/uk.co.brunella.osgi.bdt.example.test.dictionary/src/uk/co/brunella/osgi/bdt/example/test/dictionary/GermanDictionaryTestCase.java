...
@Description("Test case for the german dictionary")
public class GermanDictionaryTestCase implements OSGiTestCase, OSGiTestParameter {

  private BundleContext context;
  private ServiceTracker dictionaryTracker;

  public GermanDictionaryTestCase(BundleContext context) {
  ...
  public void setUp() throws InvalidSyntaxException {
    String filterContent = "(&(objectClass=" + DictionaryService.class.getName() + ")(Language=German))";
