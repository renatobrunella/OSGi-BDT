package uk.co.brunella.osgi.bdt.example.sensor.temperature.ice.test;
...
public class IceTemperatureSensorTest {
  ...
  private Bundle findSensorBundle() {
    for (Bundle bundle : context.getBundles()) {
      if ("uk.co.brunella.osgi.bdt.example.sensor.temperature.ice".equals(bundle.getSymbolicName())) {
        return bundle;
      }
    }
